...
function PropertiesPageInner() {
  ...
  const isCategoryPage =
    (typeParam === 'land' && purposeParam === 'buy') || // Lands for Sale
    (typeParam === 'house' && (purposeParam === 'rent' || purposeParam === 'buy')) // Houses for Rent/Sale

  const [filters, setFilters] = useState<SearchFilters>({
    location: searchParams.get('location') || '',
    propertyType: (typeParam as 'land' | 'house') || undefined,
    purpose: (purposeParam as 'buy' | 'rent') || undefined,
    minPrice: undefined,
    maxPrice: undefined,
  })
  ...
  }, [searchParams, typeParam, purposeParam])
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            {isCategoryPage
              ? typeParam === 'land' && purposeParam === 'buy'
                ? 'Lands for Sale'
                : typeParam === 'house' && purposeParam === 'rent'
                ? 'Houses for Rent'
                : typeParam === 'house' && purposeParam === 'buy'
                ? 'Houses for Sale'
                : 'Properties'
              : 'All Properties'}
          </h1>
          ...
          {!isCategoryPage && (filters.propertyType || filters.purpose || filters.location) && (
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          {/* Filters Sidebar (hidden on preset category pages) */}
          {!isCategoryPage && (
            ...
            {isLoading ? (
              <div className="text-center py-12">
                <div className="text-gray-400 mb-4">
                  <svg className="mx-auto h-10 w-10 animate-spin" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v4m0 8v4m8-8h-4M8 12H4m12.364-4.364l-2.828 2.828M9.172 14.828l-2.828 2.828m0-11.656l2.828 2.828m5.364 5.364l2.828 2.828" />
                  </svg>
                </div>
