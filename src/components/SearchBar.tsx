...
const SearchBar = () => {
  ...
  return (
    <div className="bg-white/90 backdrop-blur-xl border border-gray-200/80 shadow-xl px-1 py-0.5 sm:px-2 sm:py-1 rounded-full max-w-[260px] sm:max-w-2xl mx-auto transition-all duration-200">
      <div className="flex flex-row flex-wrap items-stretch gap-0.25 sm:flex-nowrap sm:gap-1 sm:gap-3">
        {/* Location */}
        <div className="relative flex-1 min-w-[120px] sm:flex-1" ref={dropdownRefs.location}>
          <div className="relative">
            <MapPin className="absolute left-1.5 sm:left-3 top-1/2 transform -translate-y-1/2 h-2.5 w-2.5 sm:h-3.5 sm:w-3.5 text-gray-400 z-10" />
            <input
              type="text"
        ...
        <div className="relative flex-1 min-w-[120px] sm:flex-1" ref={dropdownRefs.propertyType}>
          <div className="relative">
            <Building2 className="absolute left-1.5 sm:left-3 top-1/2 transform -translate-y-1/2 h-2.5 w-2.5 sm:h-3.5 sm:w-3.5 text-gray-400 z-10" />
            <button
              type="button"
            ...
            >
              ...
              <ChevronDown className={`h-2 w-2 sm:h-3 sm:w-3 text-gray-400 transition-transform ${openDropdown === 'propertyType' ? 'rotate-180' : ''}`} />
            </button>
        ...
        <div className="relative flex-1 min-w-[120px] sm:flex-1" ref={dropdownRefs.purpose}>
          <div className="relative">
            <Target className="absolute left-1.5 sm:left-3 top-1/2 transform -translate-y-1/2 h-2.5 w-2.5 sm:h-3.5 sm:w-3.5 text-gray-400 z-10" />
            <button
              type="button"
            ...
            >
              ...
              <ChevronDown className={`h-2 w-2 sm:h-3 sm:w-3 text-gray-400 transition-transform ${openDropdown === 'purpose' ? 'rotate-180' : ''}`} />
            </button>
        ...
        <div className="flex-none sm:ml-auto">
          <Button
            ...
            className="w-8 h-8 sm:w-10 sm:h-10 sm:px-3 bg-gradient-to-r from-primary-600 to-primary-500 hover:from-primary-500 hover:to-primary-400 text-white font-semibold rounded-full flex items-center justify-center text-[10px] sm:text-[12px] shadow-lg p-0"
          >
